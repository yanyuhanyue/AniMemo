...
SHARED_VPS_HOST = "45.207.221.83"
SHARED_VPS_PORT = 2233
...
def _validate_immutable_plan_authority(
    ...
    _require(
        ...
        and all(type(item) is str for item in unsigned.values())
        and all(
...
def _verify_shared_vps_private_read_only(
    *,
    ...
    _require(
        type(host) is str
        and host == SHARED_VPS_HOST
        and type(port) is int
        and port == SHARED_VPS_PORT
