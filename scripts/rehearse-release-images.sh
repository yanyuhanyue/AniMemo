...
ANIMEMO_INSTANCE_NAME=release-rehearsal
ANIMEMO_INSTANCE_ID=12345678-1234-4234-9234-123456789abc
ANIMEMO_COMPOSE_PROJECT=$PROJECT_NAME
...
ANIMEMO_CONFIG_REVISION=33333333-3333-4333-8333-333333333333
...
export ANIMEMO_INSTANCE_NAME="release-rehearsal"
export ANIMEMO_INSTANCE_ID="12345678-1234-4234-9234-123456789abc"
export ANIMEMO_COMPOSE_PROJECT="$PROJECT_NAME"
export ANIMEMO_MANAGED_ENV_PATH="$ENV_FILE"
export ANIMEMO_UPDATER_RUNTIME_ROOT="$TEMP_ROOT/updater-runtime"
...
export ANIMEMO_CONFIG_REVISION="33333333-3333-4333-8333-333333333333"
