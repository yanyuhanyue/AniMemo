...
WIRE_REPAIR_AUTHORIZATION = 'ANIMEMO_V2_CANDIDATE_RECEIPT_WIRE_REPAIR_SINGLE_CAPTURE_V1'
PUBLISH_WORKFLOW_REPAIR_AUTHORIZATION = 'ANIMEMO_V2_CANDIDATE_PUBLISH_WORKFLOW_REPAIR_SINGLE_CAPTURE_V1'
...
CAPTURE_LEDGERS = MappingProxyType({
    ...
    WIRE_REPAIR_AUTHORIZATION: Path('E:/') / hashlib.sha256(WIRE_REPAIR_AUTHORIZATION.encode('ascii')).hexdigest(),
    PUBLISH_WORKFLOW_REPAIR_AUTHORIZATION: Path('E:/') / hashlib.sha256(PUBLISH_WORKFLOW_REPAIR_AUTHORIZATION.encode('ascii')).hexdigest(),
})
