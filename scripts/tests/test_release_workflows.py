...
class ReleaseWorkflowContractTests(unittest.TestCase):
    def test_ci_and_release_gate_are_reusable_full_gates(self):
        ...
        self.assertIn("upgrade_base_sha", ci["on"]["workflow_call"]["inputs"])
        ...
        self.assertIn("inputs.upgrade_base_sha && 'workflow_call'", ci_source)
        self.assertIn("inputs.upgrade_base_sha && 'workflow_call'", gate_source)
        self.assertIn("INPUT_UPGRADE_BASE_SHA: ${{ inputs.upgrade_base_sha", gate_source)
