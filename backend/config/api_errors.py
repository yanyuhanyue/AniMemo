...
_PUBLIC_FAILURE_SPECS = MappingProxyType({
    ...
    "bundle_restore_stale": _spec({409}, "恢复会话已变化，请重新读取状态。"),
    "bundle_restore_expired": _spec({410}, "恢复会话已过期，请重新选择原文件。"),
    "bundle_restore_state": _spec({409}, "当前恢复状态不允许此操作，请读取会话状态。"),
    "bundle_restore_idempotency_conflict": _spec({409}, "恢复请求标识已绑定另一份数据包。"),
    "bundle_restore_capacity": _spec({413}, "数据包超过当前恢复配置的操作预算，请使用较大恢复配置。"),
    "bundle_restore_active": _spec({409}, "已有未终结的恢复会话，请继续或取消该会话。"),
    "bundle_restore_chunk_conflict": _spec({409}, "上传块与恢复会话的偏移或内容不符。"),
    "bundle_restore_incomplete": _spec({409}, "数据包尚未上传完整。"),
    "bundle_restore_busy": _spec({429}, "恢复校验或提交正在使用可用资源，请稍后重试。"),
    "bundle_restore_storage": _spec({507}, "恢复暂存不可用；已保留会话，请使用关联编号联系管理员。"),
    ...
    "media_hold_unavailable": _spec({400}, "无法确认该托管封面的持有条件，请重新上传或联系管理员。"),
    "media_usage_unknown": _spec({400}, "历史封面用量尚未核验，暂时无法增加托管封面用量。"),
    "poster_quota_exceeded": _spec({400}, "个人封面用量已达到配额，可清空或减少已有封面。"),
    "media_owner_change_denied": _spec({400}, "不能转移条目或媒体的所属用户。"),
    ...
    "public_catalog_cursor_invalid": _spec({400}, "分页凭据无效，请重新加载。"),
    "public_catalog_cursor_expired": _spec({410}, "分页凭据已过期，请重新加载。"),
    "public_catalog_cursor_mismatch": _spec({400}, "分页凭据与当前查询不匹配，请重新加载。"),
    "public_catalog_revision_changed": _spec({409}, "公开记录已更新，请重新加载。"),
    "public_catalog_budget_exceeded": _spec({500}, "公开目录响应未能在限额内完成。"),
    "public_catalog_unavailable": _spec({503}, "公开目录暂时不可用。"),
    "public_catalog_retired": _spec({410}, "此公开目录接口已停用，请使用新版公开目录接口。"),
