...
INTEGRATION_ACTION_RESPONSE_MAX_BYTES = int(
    os.getenv("INTEGRATION_ACTION_RESPONSE_MAX_BYTES", str(256 * 1024))
)
...
INTEGRATION_ACTION_RECEIPT_RETENTION_SECONDS = int(
    os.getenv("INTEGRATION_ACTION_RECEIPT_RETENTION_SECONDS", "604800")
)
WATCH_HISTORY_IMPORT_TOTAL_UPLOAD_MAX_BYTES = int(
    os.getenv("WATCH_HISTORY_IMPORT_TOTAL_UPLOAD_MAX_BYTES", str(4 * 1024 * 1024))
)
WATCH_HISTORY_IMPORT_BATCH_MAX_BYTES = int(
    os.getenv("WATCH_HISTORY_IMPORT_BATCH_MAX_BYTES", str(40 * 1024 * 1024))
)
WATCH_HISTORY_IMPORT_BATCH_MAX_PER_USER = int(
    os.getenv("WATCH_HISTORY_IMPORT_BATCH_MAX_PER_USER", "4")
)
WATCH_HISTORY_IMPORT_BATCH_RETENTION_SECONDS = int(
    os.getenv("WATCH_HISTORY_IMPORT_BATCH_RETENTION_SECONDS", "604800")
)
...
if min(
    ...
    INTEGRATION_ACTION_RESPONSE_MAX_BYTES,
    ...
    INTEGRATION_ACTION_RECEIPT_RETENTION_SECONDS,
) < 1:
...
if min(
    WATCH_HISTORY_IMPORT_TOTAL_UPLOAD_MAX_BYTES,
    WATCH_HISTORY_IMPORT_BATCH_MAX_BYTES,
    WATCH_HISTORY_IMPORT_BATCH_MAX_PER_USER,
    WATCH_HISTORY_IMPORT_BATCH_RETENTION_SECONDS,
) < 1:
    raise ImproperlyConfigured("Watch History Import 批次限制必须为正数。")
...
MIDDLEWARE = [
    "config.cache_policy.PrivateApiCacheMiddleware",
